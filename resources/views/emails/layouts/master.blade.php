...
<body style="margin:0; padding:0; background:#eef1f5; font-family: 'Segoe UI', Arial, Helvetica, sans-serif; -webkit-font-smoothing:antialiased;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">@yield('preheader', 'Pesan dari Hotel Ciputra Membership')</div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
                    <tr>
                        <td align="center" style="padding-bottom:4px;">
                            <img src="{{ $appUrl }}/images/logo-header.png" alt="Hotel Ciputra Membership" width="220" style="display:block; border:0; outline:none; text-decoration:none;">
                        </td>
                    </tr>
                </table>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px; max-width:100%; background:#ffffff; border-radius:14px; overflow:hidden; box-shadow:0 2px 8px rgba(10,28,50,0.10);">
                    ...
                    <tr>
                        <td style="background:#0f2a4a; padding:20px 40px 24px; text-align:center;">
                            <div style="color:#fbbf24; font-size:11px; letter-spacing:4px; font-weight:bold; text-transform:uppercase;">@yield('eyebrow', 'Hotel Ciputra Membership')</div>
                    ...
                    <tr>
                        <td style="padding:0 40px 32px;">
                            ...
                            <p style="color:#6b7280; font-size:13px; margin:18px 0 0;">@yield('closing', 'Terima kasih atas kepercayaan Anda.')<br><strong style="color:#0f2a4a;">Hotel Ciputra Membership Team</strong></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background:#0a1c32; padding:26px 40px; text-align:center;">
                            <div style="color:#dbeefe; font-size:13px; font-weight:bold; letter-spacing:1px;">HOTEL CIPUTRA</div>
                            <div style="color:#fbbf24; font-size:10px; letter-spacing:3px; margin-top:2px;">MEMBERSHIP &bull; JAKARTA &bull; SEMARANG</div>
                            ...
                            <p style="color:#93a8c4; font-size:11px; margin:0 0 6px; line-height:1.7;">
                                Email otomatis dari sistem Hotel Ciputra Membership.<br>
                                Mohon tidak membalas email ini secara langsung.
                            </p>
                            <p style="color:#64788f; font-size:11px; margin:0;">
                                &copy; {{ date('Y') }} Hotel Ciputra Membership. All rights reserved.<br>
